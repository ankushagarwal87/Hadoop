...
LOCATION '/project/social_links/url_cat/'

LOAD DATA LOCAL INPATH '/project/social_links/url_cat/' into table URL_CAT;
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t'
LOCATION '/project/social_links/url_review_distict/'

LOAD DATA LOCAL INPATH '/project/social_links/url_review_distict/' into table URL_REVIEW_DISTICT;



insert overwrite  directory '/project/social_links/reviewfinal/'
